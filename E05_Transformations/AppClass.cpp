...
void AppClass::InitVariables(void)
{
	...
	m_pCube->GenerateCylinder(0.5f, 0.5f, 10, RERED);
...
void AppClass::Update(void)
{
	...
	m_m4Sphere = glm::translate(IDENTITY_M4, vector3(3.0f, 2.5f, 0.0f));
	m_m4Cone = glm::translate(IDENTITY_M4, vector3(0.0f, 2.0f, 0.0f));
	m_m4Tube = glm::translate(IDENTITY_M4, vector3(0.0f, -1.5f, 0.0f));
	m_m4Cylinder = glm::translate(IDENTITY_M4, vector3(-1.5f, 0.0f, 0.0f));
	m_m4Cube = glm::translate(IDENTITY_M4, vector3(1.3f, 0.0f, 0.0f));
	

	//This matrices will scale them to the right size
	m_m4Sphere = glm::scale(m_m4Sphere, vector3(2.0f, 2.0f, 2.0f));
	m_m4Cone = glm::scale(m_m4Cone, vector3(1.5f, 1.5f, 2.0f));
	m_m4Tube = glm::scale(m_m4Tube, vector3(1.5f, 1.5f, 2.0f));
	m_m4Cylinder = glm::scale(m_m4Cylinder, vector3(1.5f, 1.5f, 2.0f));
	m_m4Cube = glm::scale(m_m4Cube, vector3(0.7f, 1.2f, 2.0f));
	m_m4Torus = glm::scale(m_m4Torus, vector3(1.0f, 1.0f, 1.0f));
